/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.template.jsonc`
// Runtime types generated with workerd@1.20260317.1 2026-03-24
// Note: vars are widened to `string` (Wrangler emits narrow literals from wrangler.template.jsonc
// placeholder values). CF_AI_GATEWAY_TOKEN is a secret — not auto-generated, declared manually.
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "AgentSessionDO";
	}
	interface Env {
		CONFIG: KVNamespace;
		ASSETS: R2Bucket;
		...
		/** Cloudflare account ID — var set in wrangler.jsonc */
		CF_ACCOUNT_ID: string;
		/** AI Gateway name / slug — var set in wrangler.jsonc */
		CF_AI_GATEWAY_NAME: string;
		/** AI Gateway API token — secret: `wrangler secret put CF_AI_GATEWAY_TOKEN` */
		CF_AI_GATEWAY_TOKEN: string;
		/** Display name injected into the base system prompt — var set in wrangler.jsonc */
		AGENT_NAME: string;
