/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 78400b99270fb64f4ddbe12ced57cd8a)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CF_ACCOUNT_ID: "e415f1017791ced9d5f3eb0df2b31c9e";
		CF_AI_GATEWAY_NAME: "mikea-piccolo";
		AGENT_NAME: "Piccolo";
		MODELS: "workers-ai/@cf/moonshotai/kimi-k2.5,workers-ai/@cf/meta/llama-3.3-70b-instruct-fp8-fast,workers-ai/@cf/meta/llama-4-scout-17b-16e-instruct";
		COMPACT_TOKENS: "100000";
		AGENT_SESSION: DurableObjectNamespace<import("./index").AgentSessionDO>;
		EXTENSION_FETCH_TOOL: Fetcher /* ext-fetch-tool */;
		EXTENSION_R2_TOOL: Fetcher /* ext-r2-tool */;
		EXTENSION_INSTRUCTIONS: Fetcher /* ext-instructions */;
	}
}
