/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.template.jsonc` (hash: 6f563bf090173f9f6fce52497581fb0f)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "TelegramSessionDO";
	}
	interface Env {
		ALLOWED_TELEGRAM_USER_IDS: "[]";
		TELEGRAM_BOT_FIRST_NAME: "piccolo";
		TELEGRAM_BOT_USERNAME: "piccolo_bot";
		TELEGRAM_SESSION: DurableObjectNamespace<import("./index").TelegramSessionDO>;
